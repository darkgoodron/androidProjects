package ru.mirea.vetoshkin.yandexmaps;
...
class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yandexmaps);
        // Укажите имя activity вместо map.
        mapView = findViewById(R.id.mapview);
        isWork = checkPermissions(this, PERMISSIONS);
        if (isWork){
            loadLocationLayer();
        } else {
    ...
    private void loadLocationLayer(){
