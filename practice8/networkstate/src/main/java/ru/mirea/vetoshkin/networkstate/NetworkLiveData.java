package ru.mirea.vetoshkin.networkstate;
...
public class NetworkLiveData extends LiveData<String> {
    ...
    // Отслеживание изменения состояния сети осществляется через BroadcastReceiver. При изменении состояния генерируется
